<?php if (!defined('BASEPATH'))
     ...
     * 30-07-2018
     */
class ImprimirSecciones extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->cezpdf->ezText('Listado de Secciones',15);  //insert text with size
       ...
       // $this->cezpdf->ezSetY(740);
        ...
        $secciones=$this->db->query('SELECT * FROM secciones');      
