        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket">
                ...
                <li class="nav-parent"><a href="<?php echo base_url() ?>"><i class="fa fa-asterisk"></i> <span>Ordenes de trabajo</span></a>
                    <ul class="children">
                        <li><a href="<?php echo base_url() ?>inicio/secretariaPanel"><i class="fa fa-bell"></i> <span>Ver clientes</span></a></li>
                        <li><a>Realizar control</a></li>
                        <a href="<?php echo base_url() ?>inicio/controlistaPanel"><i class="fa fa-bell"></i> <span></span></a></li>
                        <a href="<?php echo base_url() ?>inicio/asesorCitas"><i class="fa fa-envelope-o"></i> <span>Citas</span></a></li>
                    </ul>
                </li>
