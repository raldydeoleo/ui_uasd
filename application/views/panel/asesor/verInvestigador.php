    ...
    <div class="col-md-12" xmlns="http://www.w3.org/1999/html">
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h1 class="panel-title">Vista individual Investigador</h1>
            </div>
...
<b>Area  </b>:<?php $idc=$estudiante->id_carrera; 

$mysqli =new mysqli("localhost", "root","", "db_uasd");
    if ($mysqli === false){
        die("Error: No se establecio la conexion." . mysqli_connect_error());
    }
    $sql = "SELECT nombre_facultad FROM facultades WHERE id_facultad=".$idc."";
...
?>
    ...
    <div class="media">
        ...
        <div class="media-body">
             ...
             <h4 class="person-name"><i class=""></i>Investigador :<?php  echo $estudiante->nombre_estudiante; ?> <?php  echo $estudiante->apellido_estudiante; ?></h4>
             <h4 class="person-name"><i class=""></i> Título : <?php  echo $estudiante->matricula_estudiante; ?></div>
             <div class="text-muted"><i class="fa fa-map-marker"></i><?php  echo $estudiante->direccion_estudiante; ?></div>
             <div class="text-muted"><i class="fa fa-briefcase"></i> <a href="">Trabaja en: <?php  echo $estudiante->empresa_estudiante; ?></a></div>
             
             <div class="text-muted"><i class="fa fa-phone"></i> Telefono: <?php  echo $estudiante->telefono_estudiante; ?></div>

             <div class="col-md-4"> <a class="btn btn-info" href="<?php echo base_url() ?>index.php/investigadores"> Volver atrás </a> </div>
         </div>
    </div>
</div>
