                    ...
                    <div class="form-group">                           
                       ...
                       */ ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group mb15 col-sm-12">
                                    <?php  echo form_input($seccion_seleccion); ?>
                                </div>
                            </div>
...
$("#add").click(function(){
            var contenidofila;
            var filas = 0
            //var id_asig = document.getElementById("id_asignatura").value;
        ...
        //document.getElementById("asignatura1").value=tdElem1;   
          ...
          alert(campo1 + ' - ' + campo2 + ' - ' + campo3 +' - ' + campo3);
