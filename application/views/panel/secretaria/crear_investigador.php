        ...
        <div class="col-md-12">
            <div class="panel-primary">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Registro de Investigador</h4>
                </div>
            </div>



<?=form_open(base_url().'investigadores/insertar_investigador');
...
?>
                           ...
                           <div class="form-group">
                               <div class="col-md-8">
                               <div> <a class="btn btn-success" href="<?php echo base_url() ?>index.php/investigadores/listaInvestigadores"> Ver Listado </a> </div>
