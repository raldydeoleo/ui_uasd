<?php /** @var array $asignaturas */?>
    ...
    <div class="panel-heading">
        <h4 class="panel-title">Lista de Asignaturas</h4>
        ...
        <table class="table table-info table-hover" id="table1">
                ...
                <tr class="odd gradeX">
                    ...
                    <td><?php echo $asignatura->creditos_asignatura ?></td>
                    <td><?php echo $asignatura->horasp_asignatura ?></td>
                    <td><?php echo $asignatura->horast_asignatura ?></td>
                 ...
                 <div class="btn-group">
                   <a data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-gear"></i> </a>
                    ...
                    <li><a href="<?php echo base_url() ?>index.php/imprimirAsignaturas/pdf_asignatura/<?php echo $asignatura->id_asignatura ?>">Imprimir</a></li>
                    ...
                    <li><a href="<?php echo base_url() ?>asignaturas/seccionesPorAsignatura/<?php echo $asignatura->id_asignatura ?>">Secciones</a></li>
                            </ul>
                </div>
