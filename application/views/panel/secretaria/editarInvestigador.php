...
<div class="col-md-8">
    ...
    <div class="panel-heading">
        ...
        <h5 class="panel-title"> Actualizar datos del Investigador </h1>
    </div>

        <div class="panel-body" >

    <form method="post" action="<?php echo base_url() ?>/investigadores/guardar_post/<?php  echo $id_estudiante ?>">
        ...
        <div class="col-md-2">
            <label> Id</label>
            <input type="text" name="id_estudiante" class="form-control" readonly='readonly'  required="required" value="<?php echo $id_estudiante; ?>" />
        </div>
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-9"><a class="btn btn-danger" href="<?php echo base_url() ?>index.php/investigadores/index">Cancelar</a></div>
